    ...
    <body>
        ...
        <div class="overlay">
            ...
            <div class="prestamo-estudiante" id="prestamo-estudiante">
                ...
                <form class ="pe" action="ServletPrestamo" method="get">
                    <h1>Prestamo Personal</h1>
                    <input id="ppState" type="hidden" value="${ppState}">
                    <input type="text" name="ide" placeholder="DNI">
                    <label for="tprestamoe">Elija un tipo de prestamo:</label>
                    <select id="tprestamoe" name="tprestamoe">
                        <option value="Prestamo Estudiantil">Prestamo Estudiantil</option>
                    </select><br>
                    <label for="fechae">Fecha de inicio del prestamo:</label>
                    <input type="text" name="fechae"><br>
                    <label for="amounte">Elija la cantidad que requiere:</label>
                    <select id="amounte" name="amounte">
                        <option value="4000">4000</option>
                        <option value="5000">5000</option>
                        <option value="6000">6000</option>
                        <option value="7000">7000</option>
                    ...
                    <div class="rangev">
                        ...
                        <label for="range">Seleccione las cuotas en las que desea pagar:</label>
                        <input type="range" class="range" name="duese" value="0" min="2" max="24" onmousemove="rangeSlider1(this.value)" onchange="rangeSlider1(this.value)">
                    </div>
                    <br>
                    <label for="pagoxmese">Pago por mes:</label>
                    <input type="text" name="pagoxmese"><br>
                    <label for="card_numbere">Número de tarjeta:</label>
                    <input type="text" name="card_numbere"><br>
                    <label for="card_datee">Fecha de creación de la tarjeta:</label>
                    <input type="text" name="card_datee"><br>
                    <label for="card_safecodee">Codigo de la tarjeta:</label>
                    <input type="text" name="card_safecodee"><br>
                    <input type="submit" class="solpp" value="Solicitar Prestamo">
                </form>
            </div>
        </div>
